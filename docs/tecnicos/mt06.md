...
Aclaracion sobre el proceso de debounce implementado para el pulsador:
...
cppCopyif(!digitalRead(BUT) && !pressed){
  pressed = true;
  i = i + 1;
  Serial.println(i);
}
...
marcel2motor - Wokwi ESP32, STM32, Arduino Simulator 
...
<iframe width="560" height="315" src="https://youtu.be/gRTwzIjqgp8" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
**Figura 6**, video del timelapse del procesamiento de la pieza impresa. 
